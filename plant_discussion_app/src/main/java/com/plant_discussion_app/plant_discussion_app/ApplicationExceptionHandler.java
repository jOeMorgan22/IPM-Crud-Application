...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler{
    ...
    @ExceptionHandler({UserNotFoundException.class, ReportNotFoundException.class, NoReportsFoundException.class, 
        UserNameNotFoundException.class, NoActionsFoundException.class, ActionNotFoundException.class})
